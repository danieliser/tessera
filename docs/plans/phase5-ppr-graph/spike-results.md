...
|--------|-------|------|--------|
| Tessera PPR time | 0.76ms | <100ms | ✅ |
| Avg PPR time (all projects) | 0.76ms | <100ms | ✅ |
| Max PPR time | 0.76ms | <100ms | ✅ |
