...
|--------|-------|------|--------|
| Tessera PPR time | 3.81ms | <100ms | ✅ |
| Avg PPR time (all projects) | 3.81ms | <100ms | ✅ |
| Max PPR time | 3.81ms | <100ms | ✅ |
