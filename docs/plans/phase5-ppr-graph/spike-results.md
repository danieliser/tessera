...
|--------|-------|------|--------|
| Tessera PPR time | 0.89ms | <100ms | ✅ |
| Avg PPR time (all projects) | 0.89ms | <100ms | ✅ |
| Max PPR time | 0.89ms | <100ms | ✅ |
