...
from tessera.search import hybrid_search, rrf_merge
...
class TestPPRGraphMetrics:
    ...
    def test_tessera_project_indexing_and_graph_extraction(self):
        ...
        """
        tessera_root = Path(__file__).parent.parent.parent / "src" / "tessera"
...
class TestRRFMergeWith3Way:
    ...
    def test_sparse_graph_fallback(self):
        ...
        n = 5
        is_sparse = n > 2  # edge_count < symbol_count
        print("\n=== Sparse Graph Check ===")
...
def save_spike_results():
    ...
    output_dir = Path(__file__).parent.parent.parent / "docs" / "plans" / "phase5-ppr-graph"
